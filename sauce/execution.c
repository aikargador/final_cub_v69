...
/*   Updated: 2023/11/22 12:35:42 by aikram           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	mlx_starter(t_able *table)
{
	...
	mlx_hook(table->mlx.win, 17, 1 << 10, &mouse_hook, table);
...
void	init_table(t_able *table, t_parse *parse, t_data *data)
{
